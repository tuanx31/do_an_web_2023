...
const ChinhSachBaoMat = () => {
    return (<Container>
        <div className="cs">
            <div>
                <h4 className="hah fw-bold my-2">CHÍNH SÁCH BẢO MẬT</h4>
            </div>
            <div className="pa my-3" >
                ...
                <p><span className="hight">Mọi thông tin giao dịch sẽ được bảo mật</span> ngoại trừ trong trường hợp cơ quan pháp luật yêu cầu</p>
            </div>
        </div>
    </Container>);
}
