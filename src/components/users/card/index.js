            ...
            <Card className="shadow">
                ...
                <Card.Body className="d-flex flex-column justify-content-between">
                    ...
                    <Card.Text className="d-flex justify-content-around text-truncate">
                        <strong >{(sale_of ? price - price * sale_of / 100 : price).toLocaleString()} VND</strong> <span className="text-decoration-line-through float-end">{price.toLocaleString()} VND</span>
                    </Card.Text>
                </Card.Body>
